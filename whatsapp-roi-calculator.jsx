...
const BENCH={whatsapp:{"Developed West":{deliveryRate:96,openRate:90,ctr:25},"Developed Asia":{deliveryRate:97,openRate:95,ctr:28},"Emerging Asia":{deliveryRate:97,openRate:98,ctr:35},"LATAM":{deliveryRate:97,openRate:98,ctr:38},"MENA":{deliveryRate:96,openRate:97,ctr:32}},sms:{"Developed West":{deliveryRate:95,openRate:98,ctr:11},"Developed Asia":{deliveryRate:92,openRate:98,ctr:9},"Emerging Asia":{deliveryRate:85,openRate:98,ctr:5},"LATAM":{deliveryRate:86,openRate:98,ctr:4},"MENA":{deliveryRate:85,openRate:98,ctr:5}},email:{"Developed West":{deliveryRate:95,openRate:21,ctr:2.5},"Developed Asia":{deliveryRate:93,openRate:19,ctr:2.2},"Emerging Asia":{deliveryRate:90,openRate:17,ctr:1.8},"LATAM":{deliveryRate:88,openRate:16,ctr:1.7},"MENA":{deliveryRate:90,openRate:18,ctr:1.9}}};
...
export default function App(){
  ...
  const sim=useMemo(()=>{
    ...
    const simMsgSpend=w.msgSpend*scale;
    const simSpend=simMsgSpend+bspMo;
    const simRoi=simSpend>0?simRev/simSpend:0;
    return{
      messages:simMsgs,conversions:simConv,revenue:simRev,
      spend:simSpend,roi:simRoi,
      deltaRev:simRev-w.revenue,deltaConv:Math.round(simConv-w.conversions),
      deltaSpend:simSpend-w.spend,deltaRoi:simRoi-w.roi,
    };
  },[allR.whatsapp,simScale,bspMo]);
    ...
    <div style={{maxWidth:960,margin:"0 auto",paddingTop:24,animation:"fadeUp 0.5s ease both"}}>
      ...
      {((mode==="basic"&&step===3)||(mode==="advanced"&&step===4))&&<div>
        ...
        {mode==="basic"&&allR.whatsapp&&<div>
          ...
          {sim&&<div style={{
            background:`linear-gradient(135deg, ${T.darkCard} 0%, #1a2235 100%)`,
            borderRadius:T.radius,padding:24,marginTop:20,
            border:`1px solid ${T.darkCardLight}`,animation:"fadeUp 0.5s ease 0.2s both",
          }}>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:4}}>
